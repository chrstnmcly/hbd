  ...
  return (
    <StyledHome data-testid="container">
      <div className="home-container">
        <div className="title"><img src="/audio/HBD.png"></img></div>
        ...
        <button className="button-click" onClick={startAudioCapture}>{blowingStarted ? "hipan mo ko!" : "Make a wish tapos hipan mo!"}</button>
        <div>
...
const StyledHome = styled.div`
  ...
  background-image: url('https://wallpapers.com/images/featured/white-silk-background-yy317bhqcl5gfygv.jpg');
...
.chocs {
  ...
  z-index:1;
  border-radius: 50% 50% 50% 50% / 0% 0% 100% 100%;
  box-shadow: 49px 20px #F6F6F6, 98px 25px #F6F6F6, 147px 30px #F6F6F6, 196px 25px #F6F6F6, 245px 20px #F6F6F6, 295px 0 #F6F6F6, 0px 4px #F6F6F6, 49px 24px #fff, 98px 29px #fff, 147px 34px #fff, 196px 29px #fff, 245px 24px #fff, 295px 4px #fff;
}
